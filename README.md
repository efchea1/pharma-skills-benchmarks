...
[pharma-skills](https://github.com/RConsortium/pharma-skills) project, covering the **group-sequential-design**, **admiral-adsl**, **admiral-bds**, **clinical-trial-simulation**, and **r2rtf** AI agent skills.
...
Motivated by Jeff Dickinson's pharmaverse blog post, ["Why we still need {admiral} in an age of AI"](https://pharmaverse.github.io/blog/posts/2026-06-14_admiral_in_age_of_ai/admiral_in_age_of_ai.html) (June 14, 2026), and Yilong Zhang's follow-up request for more benchmark data to support those findings.
